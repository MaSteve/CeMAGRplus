...
<YYINITIAL> "[" { return (new Yytoken(sym.LBR, 24,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
<YYINITIAL> "]" { return (new Yytoken(sym.RBR, 25,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
