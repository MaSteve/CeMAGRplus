...
",21,-1:39,25,-1:27,26,-1:33,28,-1:2");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -3:
						break;
					case 2:
						{ return (new Yytoken(0,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -4:
						break;
					case 3:
						{
	...
	Utility.error(Utility.E_UNMATCHED);
					...
					case -5:
						break;
					case 4:
						{ return (new Yytoken(2,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -6:
						break;
					case 5:
						{ return (new Yytoken(3,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -7:
						break;
					case 6:
						{ return (new Yytoken(4,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -8:
						break;
					case 7:
						{ return (new Yytoken(5,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -9:
						break;
					case 8:
						{ return (new Yytoken(6,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -10:
						break;
					case 9:
						{ return (new Yytoken(7,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -11:
						break;
					case 10:
						{ return (new Yytoken(19,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -12:
						break;
					case 11:
						{ return (new Yytoken(12,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -13:
						break;
					case 12:
						{ return (new Yytoken(13,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -14:
						break;
					case 13:
						{ return (new Yytoken(14,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -15:
						break;
					case 14:
						{ return (new Yytoken(15,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -16:
						break;
					case 15:
						{ return (new Yytoken(16,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -17:
						break;
					case 16:
						{ }
    ...
    switch(str) {
        ...
        default: return (new Yytoken(44,yytext(),yyline,yychar,yychar + yytext().length(), yychar-col_offset));
					...
					case -21:
						break;
					case 20:
						{ return (new Yytoken(1,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -22:
						break;
					case 21:
						{ return (new Yytoken(10,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -23:
						break;
					case 22:
						{ return (new Yytoken(8,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -24:
						break;
					case 23:
						{ return (new Yytoken(9,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -25:
						break;
					case 24:
						{ return (new Yytoken(11,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -26:
						break;
					case 25:
						{ return (new Yytoken(17,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -27:
						break;
					case 26:
						{ return (new Yytoken(18,yytext(),yyline,yychar,yychar+1,yychar-col_offset)); }
					case -28:
						break;
					case 27:
						{
